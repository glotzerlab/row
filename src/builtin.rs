...
use crate::cluster::{
    Cluster, ClusterConfiguration, IdentificationMethod, Partition, SchedulerType,
};
use crate::launcher::{Launcher, LauncherConfiguration};

pub(crate) trait BuiltIn {
    fn built_in() -> Self;
}

impl BuiltIn for LauncherConfiguration {
...
impl BuiltIn for ClusterConfiguration {
    fn built_in() -> Self {
        let cluster = vec![
            ////////////////////////////////////////////////////////////////////////////////////////
            // Purdue Anvil
            Cluster {
                name: "anvil".into(),
                identify: IdentificationMethod::ByEnvironment(
                    "RCAC_CLUSTER".into(),
                    "anvil".into(),
                ),
